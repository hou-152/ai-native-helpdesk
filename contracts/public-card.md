...
- 当前本地功能分支的正式公共索引精确包含 8 张逐卡批准卡：G12／G13b 的 000001—000004，以及 Phase 6 批准的 000005—000008。新增 4 张尚未 push；远端功能分支仍为原 4 张，远端 `main` 仍只有原试运行卡。本地 8 卡可用不等于 `main` 已发布、完整知识库上线或社区验收完成。
